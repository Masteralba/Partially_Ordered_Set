...
# ВНИМАНИЕ: Дальнейший код не входит непосредственно в саму работу и написан участниками проекта
# с целью доведение проекта до логического заключения. Но оно пока что находится в разработке (не работает
# в некоторых случаях)
'''
